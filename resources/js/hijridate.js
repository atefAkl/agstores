/**
 *https://www.facebook.com/Programmer.programs
...
HijriDate.moonCycle = 29.530579166666666666666666666667;
...
HijriDate.monthNames = ["محرم", "صفر", "ربيع أول", "ربيع الآخر", "Jجمادى الأولى", "جمادة الآخرة",
					   "رجب", "شعبان", "رمضان", "شوال", "ذو القعدة", "ذو الحجة"];

HijriDate.monthShortNames = ['مح', 'صف', 'ر1', 'ر2', 'ج1', 'ج2', 'رج', 'شع', 'رم', 'شو', 'ذق', 'ذح'];

HijriDate.weekdayNames = ["الأحد", "الاثنين", "الثلاثاء", "الاربعاء", "الخميس", "الجمعة", "السبت"];

HijriDate.weekdayShortNames = ['اح', 'اث', 'ت', 'ار', 'خ', 'ج', 'س'];
...
Date.monthNames = ['يناير', 'فبراير', 'مارس', 'ابريل', 'مايو', 'يونيو', 'يوليو', 'أغسطس', 'سبتمبر', 'اكتوبر', 'نوفمبر', 'ديسمبر'];

Date.monthShortNames = ['ين', 'فب', 'مارس', 'ابر', 'مايو', 'يون', 'يول', 'اغ', 'سبت', 'اكت', 'نوف', 'ديس'];

Date.weekdayNames = ["الأحد", "الاثنين", "الثلاثاء", "الاربعاء", "الخميس", "الجمعة", "السبت"];

Date.weekdayShortNames = ['اح', 'اث', 'ت', 'ار', 'خ', 'ج', 'س'];
