...
@section('links')
    ...
    <button class="btn btn-sm btn-primary"><a href="{{ route('mainmenues.create') }}">
        ...
        <i class="fas fa-bars text-light"></i></a>
    </button>
    <button class="btn btn-sm btn-primary"><a href="{{ route('submenues.create') }}">
        <span class="btn-title"> إضافة قائمة فرعية جديدة </span>
        <i class="fas fa-caret-square-down text-light"></i></a>
    </button>
