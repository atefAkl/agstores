...
@section('links')
    <button class="btn btn-sm btn-primary"><a href="{{ route('user.create') }}"><span class="btn-title">إضافة صنف خدمى</span>
        ...
        <table dir="rtl" class="striped mt-4" style="width: 100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('users.home')}}"><i class="fa fa-eye" title="عرض بيانات العميل"></i></a>
                        <a href="{{route('users.home')}}"><i class="fa fa-edit" title="تعديل بيانات الغميل"></i></a>
                        
                        <a href="{{route('users.home', $user->id)}}" onclick="return confirm('هل تريد حذف هذا العميل بالفعل؟، هذه الحركة لا يمكن الرجوع عنها.')"><i class="fa fa-trash" title="حذف العميل"></i></a>
                    </td>
                </tr>
