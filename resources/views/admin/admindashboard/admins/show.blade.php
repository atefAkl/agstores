...
<div class="container pt-3" style="min-height: 100vh">
    <fieldset  dir="rtl" class="" >
        <legend style="right: 20px; left: auto"> تعديل بيانات مستخدم </legend>
        <br> 
        <nav>
        ...
        <div class="tab-content" id="nav-tabContent" style="">
            ...
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                ...
                <form class="mx-4" action="{{ route('users.update') }}" method="post">
                    ...
                    <div class="input-group mt-3">
                        ...
                        <input type="text" name="firstName" id="firstName" class="form-control" required value="{{ $profile->firstName }}">
                        <label for="lastName" class="input-group-text required">اسم العائلة</label>
                        <input type="text" name="lastName" id="lastName" class="form-control" required value="{{ $profile->lastName }}">
                    ...
                    <div class="input-group mt-3">
                        ...
                        <select name="profession" id="profession" class="form-control" required value="{{ $profile->profession }}">

                            <option hidden>حدد الوظيفة</option>

                            @foreach ($professions as $p => $profession)

                            <option {{ $profile->profession == $p ? 'selected' : '' }} value="{{$p}}">{{$profession[1]}}</option>
                        ...
                        <input type="date" name="dob" id="dob" class="form-control" placeholder="اسم المستخدم" required value="{{ $profile->dob }}" >
                    </div>
        
                    <div class="input-group mt-3">
                        <label for="phone" class="input-group-text">رقم الهاتف</label>
                        <input type="text" name="phone" id="dob" class="form-control" value="{{ $profile->phone }}">
                        <label for="natId" class="input-group-text required">رقم الهوية</label>
                        <input type="text" name="natId" id="natId" class="form-control" required value="{{ $profile->natId }}">
                    </div>
            ...
            @elseif ($tab == 3)
            <div class="tab-pane fade show active p-3" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="1">
                ...
                <form action="">   
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="input-group-text" data-bs-toggle="modal" data-bs-target="#addNewRule"><i class="fa fa-plus"></i></button>
                    </div>
                ...
                <div class="modal-body">
                    <form action="{{ route('users.add.rules') }}" method="POST">
                        ...
                        <div class="input-group">
                            ...
                            <button type="submit" class="input-group-text" value=""><i class="fas fa-play flipped-horisontal"></i></button>
                        </div>
                    </form>
                </div>
