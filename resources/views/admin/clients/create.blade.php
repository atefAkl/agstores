                ...
                <form class="p-3" id="regForm" action="{{ route('clients.store') }}" method="post">
                    ...
                    <table class=" w-100">
                        <tr>
                            ...
                            <td><input type="text" name="scope" id="" value="{{old('scope')}}"></td>
                        </tr>
                        <tr>
                            <td class="text-left">الرقم المسلسل:</td>
                            <td><input type="text" name="s_number" id="" value="{{old('s_number')}}"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="person" id="" value="{{old('person')}}"></td>
                            <td class="text-left">الإقامة:</td>
                            <td><input type="text" name="iqama" id="" value="{{old('iqama')}}"></td>
                        </tr>
                        <tr>
                    ...
                    <div style="">
                        ...
                        onclick="window.location=ط{{route('clients.home')}}" type="submit" id="submitBtn">إلغاء</button>
